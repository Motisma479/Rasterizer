...
CFLAGS=$(CXXFLAGS)
CPPFLAGS=-Iexternals/include -Iinclude -Ilibs -MMD
...
# PROGRAM OBJS
# OBJS=src/test/UnityTest.o libs/Math++.o
OBJS=src/App.o src/Camera.o src/Framebuffer.o src/main.o src/Renderer.o src/Scene.o libs/Math++.o src/colorApp.o src/Light.o src/Mesh.o
# DO NOT MODIFY
# GLAD
